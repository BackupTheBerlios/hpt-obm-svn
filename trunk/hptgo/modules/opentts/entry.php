...
$tts_lang_end_date_value.=$dropbox->get_dropbox("end_date_h",$end_date_h);
$dropbox = new dropbox();
$dropbox->add_arrays($mins, $mins);
$tts_lang_end_date_value.=':' . $dropbox->get_dropbox("end_date_i",$end_date_i);
}else{
...
$dropbox = new dropbox();
$dropbox->add_arrays($hours, $hours);
$tts_lang_due_date_value.=$dropbox->get_dropbox("due_date_h",$due_date_h, 'onchange="javascript:update_end_hour(this.value);"');
$dropbox = new dropbox();
$dropbox->add_arrays($mins, $mins);
$tts_lang_due_date_value.=':' . $dropbox->get_dropbox("due_date_i",$due_date_i, 'onchange="javascript:update_end_min(this.value);"');
/*
