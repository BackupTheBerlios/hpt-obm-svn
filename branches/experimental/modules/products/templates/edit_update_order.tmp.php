...
<form name="frmOrder" method="post" action="">
	...
	<tr>
 	...
 	<tr>
		...
		<td><input type="text" class="textbox" name="order_number" value="<?php echo $order['order_number']?>" style="width:300px" readonly></td>
  	</tr>  
	<tr>
...
?>	  
	  <td align="right" nowrap> 
	  	<input type="text" class="textbox" id="price<?php echo $i?>" name="price[]" style="text-align:right; width:90px" value="<?php echo $pprice?>" onKeyUp="inputNumber(this,'.');<?php echo "CalcMoney(quantity".$i.",sum".$i.",this,sum,total)"?>;">
	  ...
	  <td align="center"> <input type="text" class="textbox" id="incdec<?php echo $i?>" name="incdec[]" style="text-align:right; width:60px" value="<?php echo $pdiscount?>" onKeyUp="inputNumber(this,'%.-');<?php echo "CalcMoney(price".$i.",quantity".$i.",sum".$i.",incdec".$i.",VAT".$i.",amount".$i.",sum,total,amount,sumamount)"?>;"> </td>
...
?>			
	<tr>
	  ...
	  <td align="right"> <input type="text" class="textbox" id="price<?php echo $i.$j?>" name="price[]" style="text-align:right; width:90px" value="<?php echo $pprice?>" onKeyUp="inputNumber(this,'.');<?php echo "CalcMoney(quantity".$i.$j.",sum".$i.$j.",this,sum,total)"?>;"><input type="hidden" name="id[]" value="<?php echo $pid?>"><input type="hidden" name="id[]" value="<?php echo $pid?>"></td>
      <td align="center"> <input type="text" class="textbox" id="quantity<?php echo $i.$j?>" name="quantity[]" style="text-align:right; width:60px" value="<?php echo $pquantity?>" onKeyUp="inputNumber(this,'');<?php echo "CalcMoney(price".$i.$j.",quantity".$i.$j.",sum".$i.$j.",incdec".$i.$j.",VAT".$i.$j.",amount".$i.$j.",sum,total,amount,sumamount)"?>;"> </td>
	  <td align="center"> <input type="text" class="textbox" id="sum" name="sum<?php echo $i.$j?>" style="text-align:right; width:100px" value="<?php echo $pprice*$pquantity?>" readonly> </td>
	  <td align="center"> <input type="text" class="textbox" id="incdec<?php echo $i.$j?>" name="incdec[]" style="text-align:right; width:60px" value="<?php echo $pdiscount?>" onKeyUp="inputNumber(this,'%.-');<?php echo "CalcMoney(price".$i.$j.",quantity".$i.$j.",sum".$i.$j.",incdec".$i.$j.",VAT".$i.$j.",amount".$i.$j.",sum,total,amount,sumamount)"?>;"> </td>
