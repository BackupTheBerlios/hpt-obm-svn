		...
		<?php
			...
			foreach ($module_list as $module)
			{
				    ...
				    $GO_SECURITY->has_permission($GO_SECURITY->user_id, $module['acl_write']))
				{
					...
					echo '<td class="ModuleIcons" align="center" valign="top" nowrap><a id="'.$module['id'].'" class="FooterBar" onClick="javascript:Bold_Text(\''.$module['id'].'\')" href="'.$module['url'].'" target="main"><img src="'.$GO_THEME->images[$module['id']].'" border="0" width="32" height="32" /><br />'.(isset($lang_var) ? $lang_var : '').'</a></td>';	
					if ($show_text)
